...
abstract class Struct
{
    ...
    {
        throw new \UnexpectedValueException( 'Trying to get non-existing property ' . $property );
    }
    ...
    {
        throw new \UnexpectedValueException( 'Trying to set non-existing property ' . $property );
    }
